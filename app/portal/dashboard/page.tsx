...
export default async function Page() {
  ...
  return <><PageHeader title="แดชบอร์ด" subtitle="ภาพรวมระบบสต๊อก" /><Grid container spacing={2}><Grid size={{ xs: 6, md: 3 }}><StatCard title="จำนวนสินค้าทั้งหมด" value={pCount ?? 0} /></Grid><Grid size={{ xs: 6, md: 3 }}><StatCard title="มูลค่าสต๊อก" value={totalValue.toFixed(2)} /></Grid><Grid size={{ xs: 6, md: 3 }}><StatCard title="สต๊อกต่ำ" value={low} /></Grid><Grid size={{ xs: 6, md: 3 }}><StatCard title="สินค้าหมด" value={out} /></Grid></Grid></>;
}
